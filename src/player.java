...
public class player
{
	...
	public static void newGame() throws IOException, InterruptedException		//Create new save file with given name
	{
		...
		if(files.contains(saveName)){
			...
			save = new File("wolfFiles\\saves\\" + saveName);
			save.createNewFile();
		}
		...
		FileWriter fw = new FileWriter("wolfFiles\\saves\\" + saveName);
	...
	public static void loadSave() throws IOException, InterruptedException		//Load from an old .sav file
	{
		...
		if(files.contains(saveName)){
			File save = new File("wolfFiles\\saves\\" + saveName);
	...
	{
		File temp = new File("wolfFiles\\saves\\" + saveName);
		temp.delete();
		File save = new File("wolfFiles\\saves\\" + saveName);
		save.createNewFile();
	...
	public static void kill(){
		File you = new File("wolfFiles\\saves\\" + saveName);
		you.delete();
	}
}